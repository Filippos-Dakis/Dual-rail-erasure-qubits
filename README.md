...
This repository contains three Jupyter notebooks that reproduce the results and figures from the paper [Dynamical error reshaping for dual-rail erasure qubits](https://arxiv.org/abs/2510.08416). It also includes two ``.csv`` files with the experimentally friendly pulse shapes derived in the paper.
...
<img width="6811" height="4173" alt="Figure_1" src="https://github.com/user-attachments/assets/e089670f-8675-4e2f-a2b8-dda9a7ab13b0" />

If you have any comments or questions, feel free to contact me at dakisfilippos@vt.edu
